...
const CTASection = () => {
  ...
  return (
    <section id="contato" className="py-20 md:py-28 bg-foreground text-background">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-background/70 mb-8">
            Fale agora com a Marina e receba uma simulação gratuita e 
            personalizada. Atendimento em toda a Baixada Santista.
          </p>
